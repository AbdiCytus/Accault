...
export default function GroupCard({ id, name, count }: GroupProps) {
  return (
    <div className="relative group cursor-pointer transition-transform hover:-translate-y-1">
      ...
      {/* Kartu Utama */}
      <div className="bg-white dark:bg-gray-800 p-5 rounded-xl border-2 border-blue-100 dark:border-gray-700 shadow-sm hover:shadow-md h-full flex flex-col justify-between">
